...
#define STRING_CONFIG_H_AUTHOR "(Naruto-kyun, default config)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "CubYXRap"
...
#define PID_MAX BANG_MAX // limits current to nozzle while PID is active (see PID_FUNCTIONAL_RANGE below); 255=full current
  ...
  // Diamond
  #define  DEFAULT_Kp 79.49
  #define  DEFAULT_Ki 12.28
  #define  DEFAULT_Kd 128.61
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3]]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 80, 91 }
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3]]]
 */
#define DEFAULT_MAX_FEEDRATE          { 3000, 3000, 2000, 250 }
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3]]]
 */
#define DEFAULT_MAX_ACCELERATION      { 30000, 30000, 500, 100000 }
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define RIGHT_PROBE_BED_POSITION X_MAX_POS - 60 - 75
  #define FRONT_PROBE_BED_POSITION 60
  #define BACK_PROBE_BED_POSITION Y_MAX_POS - 60
